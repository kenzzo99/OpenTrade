		...
		<div style={{ display: 'flex', gap: '10px' }}>
			...
			>
				<Timeline mode="left" style={styles.timeline}>
					...
					<Timeline.Item dot="🔏">
						<Text delete={isServerInfo} style={styles.text}>
							Rename <Text code>.env.example</Text> to{' '}
							<Text code>.env</Text> and provide your{' '}
							<Text strong>appId</Text> and{' '}
					...
					<Timeline.Item dot="💿">
						<Text delete={isInchDex} style={styles.text}>
							...
							needed for the<Text code>{'<InchDex />'}</Text>{' '}
							component (optional)
						</Text>
					</Timeline.Item>
					...
					<Timeline mode="left" style={styles.timeline}>
						...
						<Timeline.Item dot="⚙️">
							<Text style={styles.text}>
								...
								<Text code>npm run devchain</Text> on a new
								terminal
							</Text>
						</Timeline.Item>
						<Timeline.Item dot="📡">
							<Text style={styles.text}>
								...
								<Text code>npm run deploy</Text> on a new
								terminal
							</Text>
						</Timeline.Item>
