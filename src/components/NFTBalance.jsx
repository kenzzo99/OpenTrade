...
import { getOwnerNfts } from 'helpers/ownerNFTs';
...
function NFTBalance() {
	let { NFTBalance, fetchSuccess } = useNFTBalance();
	...
	const [NFTBalanceAsync, setNFTBalanceAsync] = useState(null);

	useEffect(() => {
		async function fetchUserNfts() {
			let ownerNftsTemp = await getOwnerNfts(walletAddress, chainId);
			setNFTBalanceAsync(ownerNftsTemp);
		}
		if (chainId === '0x4') {
			fetchUserNfts();
		}
